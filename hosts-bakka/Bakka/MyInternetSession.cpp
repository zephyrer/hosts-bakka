...
void CMyInternetSession::StepIt()
{
	CBakkaDlg * pBakkaDlg = (CBakkaDlg*) AfxGetMainWnd();
	pBakkaDlg->StepIt();
}

void CMyInternetSession::StepIt(DWORD pos)
{
	CBakkaDlg * pBakkaDlg = (CBakkaDlg*) AfxGetMainWnd();
...
DWORD CMyInternetSession::GetAndSetHosts(LPCTSTR lpstrServer, int nPort, CString strFile, CStringArray* hosts)
{
